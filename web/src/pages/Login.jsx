    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      <div className="bg-white p-10 rounded-3xl shadow-2xl w-full max-w-md border-2 border-gray-100">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-gray-500 font-medium">Smart Link Organization with AI</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-gradient-to-r from-blue-600 to-purple-600 text-white py-4 rounded-xl font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:scale-100"
          >
